        ...
        if (rawMetaData.media) {
            for (let track of rawMetaData.media.track) {
                if (track["@type"] === "General" || track["@type"] === "Video" || track["@type"] === "Other") {
                    let temp = track;
                    if (track["extra"]) {
                        temp = Object.assign(Object.assign({}, track), track["extra"]);
                        delete temp.extra;
                    }
                    metaDataTracks.video = Object.assign(Object.assign({}, metaDataTracks.video), temp);
                }
                else if (track["@type"] === "Audio") {
                    metaDataTracks.audio = Object.assign(Object.assign({}, metaDataTracks.audio), track);
                }
            }
            for (let entry of Scraper.availableColumns.video) {
...
module.exports.MetaDataColumns = Scraper.getColumnNames();
